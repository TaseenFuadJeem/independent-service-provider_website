...
const Signup = () => {
    return (
        <div>
            ...
            <div class="h-screen bg-gradient-to-br from-blue-400 to-indigo-500 flex justify-center items-center w-full">
                <form>
                    <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
                        ...
                        <button class="mt-4 w-full bg-gradient-to-tr bg-indigo-500 text-white py-2 rounded-md text-lg tracking-wide">Register</button>

                        <p className='text-center my-2'>Or</p>

                        <button class="w-full bg-gradient-to-tr bg-indigo-500  text-white py-2 rounded-md text-lg tracking-wide">Continue with Google</button>
