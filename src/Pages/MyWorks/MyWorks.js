...
const MyWorks = () => {
    return (
        <div className='lg:px-32'>
            ...
            <div class=" mt-16 mb-32 container flex justify-center mx-auto">
                <div class="flex flex-row mx-auto">
                    <button type="button" class="bg-indigo-500 text-white rounded-l-md border-r border-gray-100 py-2 hover:bg-indigo-600 hover:text-white px-3">
                    ...
                    <button type="button" class="bg-indigo-500 text-white rounded-r-md py-2 border-l border-gray-200 hover:bg-indigo-600 hover:text-white px-3">
                        <div class="flex flex-row align-middle">
