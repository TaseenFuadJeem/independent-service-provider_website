                        ...
                        <div className="flex flex-row flex-wrap -mx-2">
                            <Fade left>
                                <div className="w-full md:w-1/2 h-64 md:h-auto mb-4 px-2">
                                    <img className="rounded-lg block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover object-cover" src={pic1} alt='' />
                                ...
                                <div className="flex flex-col sm:flex-row md:flex-col -mx-2">
                                    ...
                                    <Fade right>
                                        <div className="w-full sm:w-1/2 md:w-full h-48 xl:h-64 mb-4 sm:mb-0 md:mb-4 px-2">
                                            ...
                                            <img className="rounded-lg block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover object-cover" src={pic2} alt='' />

                                        </div>

                                        <div className="w-full sm:w-1/2 md:w-full h-48 xl:h-64 px-2">

                                            <img className="rounded-lg block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover object-cover" src={pic3} alt="" />
                            ...
                            <Fade bottom>
                                <div className="w-full sm:w-1/3 h-32 md:h-48 mb-4 sm:mb-0 px-2">
                                    ...
                                    <img className="rounded-lg block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover object-cover" src={pic4} alt="" />
                            ...
                            <Fade top>
                                <div className="w-full sm:w-1/3 h-32 md:h-48 mb-4 sm:mb-0 px-2">
                                    ...
                                    <img className="rounded-lg block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover object-cover" src={pic5} alt="" />
                            ...
                            <Fade bottom>
                                <div className="w-full sm:w-1/3 h-32 md:h-48 px-2">
                                    ...
                                    <img className="rounded-lg block w-full h-full bg-grey-dark bg-no-repeat bg-center bg-cover object-cover" src={pic6} alt="" />
